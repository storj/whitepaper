...
\subsection{Numerical simulations for indirect file piece loss}\label{sec:RS-sim}
...
We assume that a file undergoes the process of repair when less than $m$ pieces remain on the network, using three different values of $m$ for each $n$.
