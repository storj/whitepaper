In the context of storing an erasure-coded file on a decentralized network, we consider the loss of a {\em piece} from a {\em file} from two different perspectives.
