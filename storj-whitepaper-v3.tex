...
\section{Node churn is bad for durability}
	From the equations you see that repair bandwidth is impacted by node churn linearly, which is expected. Lower mean time to node failure triggers more frequent rebuilds and therefore more bandwidth usage. Loss rate is much more sensitive to high node churn, it increases exponentially with alpha. This necessitates very stable nodes, with lifetimes of several months, to achieve acceptable network durability. 
	

\section{Repair bandwidth limits usable space}
