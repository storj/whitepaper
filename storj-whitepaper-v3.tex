...
certain number of satellites to ensure gateway users have sufficient
...
of this first segment. The gateway will:
  ...
  \item Confirm that the gateway has appropriate authorization and funds for
    the request. The gateway must have an account with this 
...
\item The gateway will upload back to the satellite all of the signed
  ...
  to ensure that the gateway did its part in letting storage nodes know the 
  object
  has been deleted.
