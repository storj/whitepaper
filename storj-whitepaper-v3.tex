...
Storj Labs, Inc.}
\date{\small\sffamily\color{white} v3.0, October 11, 2018\\
...
%% TODO:
%% * more citations than proofs of retrievability for audits and reputation
%% * citation for distributing load by segmenting I know I read that
%% * more citations for exchange reports
%% * stream in graphic
%% * keypair dotted line
%% * ben's gdoc
...
to mere minutes \cite{dht-churn}. Churn could be caused by any number of
factors. Storage nodes
...
Many storage systems use per-file audits as a way of determining when and
where to repair files. Our storage system does not use auditing for this purpose.
...
%% TODO reference to erasure code tutorial
...
\subsection{Bandwidth allocation and exchange reporting}\label{baer}
