...
Uplink is the term which we use to identify any software or service that implements Lib Uplink in order to interact with Satellites and Storage Nodes.
...
The Gateway provides an Amazon S3-compatible, drop-in interface for users and
applications that
need to store data but don't want to bother with the complexities of distributed
storage directly. The Gateway is a simple service layer on top of {\em libuplink}.

The Gateway will run co-located with wherever data is generated, and will
