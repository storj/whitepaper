...
This adds aggressive requirements for feature set, performance, and durability.
...
\item[Peer class] A cohesive collection of network services and
  ...
  run separately and independently by different operators.
...
Storj Labs partners who host ``Tardigrade'' Satellites may receive
