...
\usepackage{xcolor}
\definecolor{ocre}{RGB}{52,117,201} % highlight color: TODO: change?
\usepackage{avant}
\usepackage{mathptmx}
...
\renewcommand{\thesection}{\arabic{section}} % get rid of chapter number

\newcommand{\x}[1]{{\tt #1}} \newcommand{\code}[1]{{\tt #1}}
\newcommand{\todo}[1]{{\color{red} TODO #1 }}
\newcommand{\bs}[1]{{\color{red}#1}}

\title{\textbf{\sffamily Storj: A Decentralized Cloud Storage Network Framework}}
\author{\small\sffamily
Storj Labs, Inc., August 23, 2018\\
\small\url{https://github.com/storj/whitepaper} \sffamily (v3)}
\date{}
