...
encryption scheme. \todo{ref to our hd scheme section}
...
in the future. File repair needs are determined based entirely on storage node
uptime and overall health.
...
failure or malintent. An audit functions as a spot check to help calculate
the future usefulness of a given storage node.

This auditing mechanism does not audit all bytes in all files and
...
$80000\cdot(32+16+4+4)/(1024\cdot 1024) \approx 4.12$
...
\todo{diagram: redundancy.png, redundancy_kmon.png}
...
\todo{diagram 4_erasure_share.png}
