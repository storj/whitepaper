...
\section{Redundancy}\label{sec:req-redundancy}
...
providers. Cloud computing is estimated to be a \$200B market in 2018
\todo{citation needed}.
...
\item Section \ref{sec:req-redundancy} needs to be written to make the
  replication-is-bad argument clear. Clean up framework redundancy section.
\end{itemize}
