...
\begin{abstract} Decentralized Cloud Storage represents a fundamental shift in
...
\item For every segment pointer requested, the heavy client will:
  \begin{itemize}
  \item Validate that the gateway has access to the segment pointer and funds to
    pay for its downloading.
