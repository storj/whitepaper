...
https://docs.google.com/document/d/1aEn1ACRayQE9JwHbqBCQSM9_9Ot1H6NbEdyZVCmhFLU/edit
}
...
\todo{stefan requests other exp factors}
...
satellite service which manages data ownership. \x{Uplinks}
...
claim to have. Auditors, such as a satellite, will send a \x{challenge} to a
storage node and expect a valid response. A challenge is a request of the
storage node for it to prove it has the data it claims to.
