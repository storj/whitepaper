...
Storj Labs, Inc.}
\date{\small\sffamily\color{white} October 26, 2018\\v3.0\\
...
rearchitectures of these systems, such as the removal of the Satellite
entirely.
...
repairing segments, and storing metadata. Every day, each Satellite will execute
