...
corners=4pt,align=left,fill=ocre!10!white,text 
opacity=1,draw=ocre,draw opacity=1,line width=1.5pt,fill opacity=0,inner 
...
{\includegraphics[width=\paperwidth,height=4cm]{\thechapterimage}};
\draw[anchor=east] (15cm,-2.2cm) node [rounded 
corners=4pt,align=left,fill=ocre!10!white,fill 
opacity=0,inner sep=12pt,text opacity=1,draw=ocre,draw opacity=1,line 
